...
export const offers: Offer[] = [
  ...
  {
    id: '5',
    title: 'Luxury apartment in Paris center',
    type: 'apartment',
    price: 250,
    rating: 4.9,
    image: '/img/apartment-02.jpg',
    ...
    bedrooms: 2,
    maxAdults: 4,
    description: 'Beautiful luxury apartment in the heart of Paris with stunning views of the Eiffel Tower.',
    goods: ['Wi-Fi', 'Washing machine', 'Towels', 'Heating', 'Coffee machine', 'Kitchen', 'Dishwasher', 'Cable TV', 'Fridge', 'Air conditioning'],
    host: {
      id: 5,
      name: 'Marie',
  ...
  },
  {
    ...
    bedrooms: 1,
    maxAdults: 2,
    description: 'Charming studio apartment located just steps from the Louvre Museum. Perfect for art lovers.',
    goods: ['Wi-Fi', 'Heating', 'Kitchen', 'Cable TV', 'Fridge'],
    host: {
      id: 6,
      name: 'Pierre',
